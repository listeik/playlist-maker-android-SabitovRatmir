...
#### Спринт 8 (v8.0)
- Реализована навигация между главным экраном и экранами Songs, Playlists, Favorites
- Создан экран создания плейлиста с полями имени и описания
- Добавлен FloatingActionButton на экран Playlists для создания плейлистов
- Реализован экран Track Details с детальной информацией о треке
- Добавлены иконки "Добавить в избранное" и "Добавить в плейлист"
- Реализован ModalBottomSheet со списком плейлистов для выбора
- Настроено сохранение состояния favorite и привязка треков к плейлистам
